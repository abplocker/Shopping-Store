...
namespace shopMobileOnline
{
    public class DataAccess
    {
        ...
        public void MoKetNoiCSDL()
        {
            ...
            // Sửa ở dòng này tuỳ theo máy
            connection.ConnectionString = @"Data Source=DESKTOP-CN58EJ1;Initial Catalog=SHOPMOBILE;User ID=sa;password=12345;MultipleActiveResultSets = true;";
